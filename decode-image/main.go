...
func main() {
	...
	data, err := ioutil.ReadFile("./encode-test.txt")
	if err != nil {
		fmt.Println("error")
	...
	//	draw.Draw(converted, bounds, img, image.ZP, draw.Src)

	//	optimizeForAverageFilter(converted.Pix, bounds, converted.Stride, 4, 100)

	//	optimized = converted

	filename := "./test-index12.jpg"
	...
	//	}
	//	err = encoder.Encode(f, optimized)
	//	if err != nil {
	//		fmt.Println(err.Error())
	//		return
	//	}
